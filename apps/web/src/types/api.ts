...
export const LLMHubModelSchema = z
  .object({
    id: z.string(),
    ...
    tokenPrices: TokenPricesSchema.optional(),
    deprecated: z.boolean().optional(),
    inPreview: z.boolean().optional(),
  }) satisfies z.ZodType<ModelMetadata>;

export const LLMHubModelsSchema = z.array(LLMHubModelSchema) as z.ZodType<ModelMetadata[]>;
...
export type LLMHubModel = ModelMetadata;
export type LLMHubModelsResponse = ModelMetadata[];
